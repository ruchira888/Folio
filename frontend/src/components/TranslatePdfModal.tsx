...
export default function TranslatePdfModal({ isOpen, onClose }: TranslatePdfModalProps) {
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      const downloadName = fileName ? fileName.replace(/\.pdf$/i, `${suffix}.pdf`) : `translated-${targetLanguage}.pdf`;
