...
export default function Hero() {
  const headline = "All-in-one PDF toolkit.";
      ...
      <div className="w-full max-w-6xl mx-auto px-6 md:px-12 pt-16 md:pt-20 pb-8">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="max-w-xl text-left">
            ...
            >
              <motion.span variants={wordVariants} className="text-[#FFEABC]">
                Smart
              </motion.span>
              ,{" "}
              <motion.span variants={wordVariants} className="text-[#EC4899]">
                fast
              </motion.span>
              ,{" "}
              <motion.span variants={wordVariants} className="text-[#E8D6FF]">
                secure
              </motion.span>
              .
            </motion.h2>
            ...
            >
              ...
              <br />
              Files auto-delete after{" "}
              <span className="text-[#EC4899] font-bold">45 mins</span>.
            </motion.p>
          </div>
          ...
          >
            ...
            >
              <path
                d="M45 35 C40 25, 30 20, 20 28 C30 26, 38 28, 45 35 Z"
                fill="#2D3A4A"
              />
              <path
                d="M45 35 C50 25, 60 22, 70 30 C60 27, 52 28, 45 35 Z"
                fill="#2D3A4A"
              />
              <path
                d="M75 22 C72 16, 65 13, 58 18 C65 17, 71 18, 75 22 Z"
                fill="#2D3A4A"
              />
              <path
                d="M75 22 C78 16, 84 14, 90 19 C84 17, 79 18, 75 22 Z"
                fill="#2D3A4A"
              />
              <path
                d="M90 42 C88 38, 83 36, 79 39 C83 38, 87 39, 90 42 Z"
                fill="#3D4A5A"
              />
              <path
                d="M90 42 C92 38, 96 37, 100 40 C96 39, 93 39, 90 42 Z"
                fill="#3D4A5A"
              />
            </svg>
          </motion.div>
